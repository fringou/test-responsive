window.onload = function(){
    const canvasWidth = 450/2;
    const canvasHeight = 300/2;
    const blockSize = 5; // en pixels
    const canvas = document.createElement("canvas");
    const parentjeu = document.getElementById('parentjeux');
    ...
    function drawScore(){
      ...
      ctx.textAlign = "center";
      ctx.textBaseline = "middle";
      ctx.fillText(score.toString(), centreX*2-10, centreY*0+10);// placement du score en haut a droite
      ctx.restore();
    }
    ...
    function snake(body, direction){
      ...
      this.draw = function(){
        ctx.save();
        ctx.fillStyle = "black";// couleur du serpent
